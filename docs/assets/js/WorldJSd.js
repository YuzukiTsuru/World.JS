...
(function() {
 var loadPackage = function(metadata) {
  ...
  var PACKAGE_NAME = "WorldJSd.data";
  var REMOTE_PACKAGE_BASE = "WorldJSd.data";
  ...
  function runWithFS() {
   ...
   function processPackageData(arrayBuffer) {
    ...
    Module["removeRunDependency"]("datafile_WorldJSd.data");
   }
   Module["addRunDependency"]("datafile_WorldJSd.data");
...
var wasmBinaryFile = "WorldJSd.wasm";
